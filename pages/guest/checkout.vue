<template lang="pug">
  .containers
    el-form.demo-refForm(:model='form' :rules='rules' ref='refForm' label-width='120px')
      .row
        .col-md-8
          h3.mb-2 Detail Pemesan
          .row
            .col-md-6
              el-form-item(label="Nama Pemesan" prop="name")
                el-input(v-model="form.name" placeholder="Masukan nama pemesan")
            .col-md-6
              el-form-item(label="Email" prop="email")
                el-input(v-model="form.email" placeholder="Masukan email pemesan")
            .col-md-12
              el-form-item(label="Catatan")
                el-input(type="textarea" v-model="params.note" placeholder="Masukan catatan (optional)")
          ...
          .address-detail
            ...
            .border-bottom.text-size-small.text-color-gray(v-if="form.addressSelected")
              ...
              p.mt-2 {{form.addressSelected.address}}, {{form.addressSelected.subdistrict_name}}, {{form.addressSelected.city_name}}
            ...
            .border-bottom
              ...
              add-dialog(v-model="state.isAddDialog" :addressSelected.sync="form.addressSelected")
        .col-md-4
          .order-info
            OrderInfo(
  ...
  setup(_, ctx) {
    ...
    function submitForm() {
      ...
      if (!form.addressSelected) {
        ...
        params.order_detail = form.name
        postData('/orders/guest', params)
      }
    }
